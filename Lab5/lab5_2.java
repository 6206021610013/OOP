...
public class lab5_2 {
    public static void main(String[] args) {
        ...
        lab5_2 maxtest = new lab5_2();
        lab5_2 mintest = new lab5_2();
        output = "number1: " + number1 + "\nnumber2: " + number2 ;
        output += "\nnumber3: " + number3 + "\nmaximum is: " + maxtest.maximum(number1, number2, number3);
        output += "\nminimum is: " + maxtest.minimum(number1, number2, number3);
